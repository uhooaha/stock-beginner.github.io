...
var documents = [{
    ...
    "id": 6,
    "url": "http://localhost:4000/categories/stock-keyword/",
    "title": "초보 주린이의 필수 주식 키워드",
    "body": ""
    }, {
    "id": 7,
    "url": "http://localhost:4000/stock-news/",
    "title": "오늘의 주식 시장은?",
    "body": "📰 오늘의 주식 시장 뉴스:  {% assign posts = site. stock-news | sort: 'date' | reverse %} {% for post in posts %}  {% include postbox. html %} {% endfor %}"
    }, {
    "id": 8,
    "url": "http://localhost:4000/categories/stock-note/",
    "title": "좌충우돌 주식 투자일지",
    "body": ""
    }, {
    "id": 9,
    "url": "http://localhost:4000/categories/stock-utilizing-tip/",
    ...
    "id": 12,
    "url": "http://localhost:4000/stock-note-start/",
